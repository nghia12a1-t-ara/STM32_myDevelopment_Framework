...
typedef struct {
	__vo uint32_t LISR;			/** DMA Low Interrupt Status Register		Offset = 0x0000 */
	__vo uint32_t HISR;			/** DMA High Interrupt Status Register		Offset = 0x0004 */
	__vo uint32_t LIFCR;			/** DMA Low Interrupt Flag Clear Register	Offset = 0x0008	*/
	__vo uint32_t HIFCR;			/** DMA High Interrupt Flag Clear Register	Offset = 0x000C */
	struct DMAStream_Types {
		__vo uint32_t CR;		/** DMA Configuration Register				Offset = 0x0010 + 0x18 × stream number */
		__vo uint32_t NDTR;		/** DMA Number of Data Register				Offset = 0x0014 + 0x18 × stream number */
		__vo uint32_t PAR;		/** DMA Peripheral Address Register			Offset = 0x0018 + 0x18 × stream number */
		__vo uint32_t M0AR;		/** DMA Memory 0 Address Register			Offset = 0x001C + 0x18 × stream number */
		__vo uint32_t M1AR;		/** DMA Memory 1 Address Register			Offset = 0x0020 + 0x18 × stream number */
		__vo uint32_t FCR;		/** DMA FIFO Control Register				Offset = 0x0024 + 0x18 × stream number */
