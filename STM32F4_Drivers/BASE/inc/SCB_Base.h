...
typedef struct {
  ...
  __IO uint32 SHP[3];                             /**< System Handler Priority Register 1, offset: 0xD18 */
  ...
  __IO uint32 MMFAR;                             	/**< Memanage Fault Address Register, offset: 0xD34 */
  __IO uint32 BFAR;                              	/**< BusFault Address Registerd, offset: 0xD38 */
  __IO uint32 AFSR;                              	/**< Auxiliary Fault Status Register, offset: 0xD3C */
  __I  uint32 ID_PFR0;                           	/**< Processor Feature Register 0, offset: 0xD40 */
  __I  uint32 ID_PFR1;                           	/**< Processor Feature Register 1, offset: 0xD44 */
  __I  uint32 ID_DFR0;                           	/**< Debug Feature Register 0, offset: 0xD48 */
  __I  uint32 ID_AFR0;                           	/**< Auxiliary Feature Register 0, offset: 0xD4C */
  __I  uint32 ID_MMFR[SCB_ID_MMFR_COUNT];    /**< Memory Model Feature Register 0..Memory Model Feature Register 3, array offset: 0xD50, array step: 0x4 */
  __I  uint32 ID_ISAR[SCB_ID_ISAR_COUNT];    /**< Instruction Set Attributes Register 0..Instruction Set Attributes Register 4, array offset: 0xD60, array step: 0x4 */
       uint8 RESERVED_2[4];
  __I  uint32 CLIDR;                             /**< Cache Level ID Register, offset: 0xD78 */
  __I  uint32 CTR;                               /**< Cache Type Register, offset: 0xD7C */
  __I  uint32 CCSIDR;                            /**< Cache Size ID Register, offset: 0xD80 */
  __IO uint32 CSSELR;                            /**< Cache Size Selection Register, offset: 0xD84 */
  __IO uint32 CPACR;                             /**< Coprocessor Access Control Register, offset: 0xD88 */
       uint8 RESERVED_3[372];
  __O  uint32 STIR;                              /**< Software Triggered Interrupt Register, offset: 0xF00 */
       uint8 RESERVED_4[48];
  ...
  __IO uint32 FPDSCR;                            /**< Floating-point Default Status Control Register, offset: 0xF3C */
       uint8 RESERVED_5[16];
  __O  uint32 ICIALLU;                           /**< Instruction cache invalidate all to Point of Unification (PoU), offset: 0xF50 */
       uint8 RESERVED_6[4];
  __O  uint32 ICIMVAU;                           /**< Instruction cache invalidate by address to PoU, offset: 0xF58 */
  __O  uint32 DCIMVAC;                           /**< Data cache invalidate by address to Point of Coherency (PoC), offset: 0xF5C */
  __O  uint32 DCISW;                             /**< Data cache invalidate by set/way, offset: 0xF60 */
  __O  uint32 DCCMVAU;                           /**< Data cache by address to PoU, offset: 0xF64 */
  __O  uint32 DCCMVAC;                           /**< Data cache clean by address to PoC, offset: 0xF68 */
  __O  uint32 DCCSW;                             /**< Data cache clean by set/way, offset: 0xF6C */
  __O  uint32 DCCIMVAC;                          /**< Data cache clean and invalidate by address to PoC, offset: 0xF70 */
  __O  uint32 DCCISW;                            /**< Data cache clean and invalidate by set/way, offset: 0xF74 */
  __I  uint32 BPIALL;                            /**< Not implemented - RAZ/WI, offset: 0xF78 */
       uint8 RESERVED_7[20];
  __IO uint32 ITCMCR;                            /**< Instruction Tightly-Coupled Memory Control Register, offset: 0xF90 */
  __IO uint32 DTCMCR;                            /**< Data Tightly-Coupled Memory Control Register, offset: 0xF94 */
  __IO uint32 AHBPCR;                            /**< AHBP control register, offset: 0xF98 */
  __IO uint32 CACR;                              /**< L1 Cache Control Register, offset: 0xF9C */
  __IO uint32 AHBSCR;                            /**< AHB Slave Control Register, offset: 0xFA0 */
       uint8 RESERVED_8[4];
  __IO uint32 ABFSR;                             /**< Asynchronous Bus Fault Status Register, offset: 0xFA8 */
       uint8 RESERVED_9[4];
  __IO uint32 IEBR0;                             /**< Instruction Error bank Register 0, offset: 0xFB0 */
  __IO uint32 IEBR1h;                            /**< Instruction Error bank Register 1, offset: 0xFB4 */
  __IO uint32 DEBR0h;                            /**< Data Error bank Register 0, offset: 0xFB8 */
  __IO uint32 DEBR1h;                            /**< Data Error bank Register 1, offset: 0xFBC */
       uint8 RESERVED_10[16];
  __I  uint32 PID[SCB_PID_COUNT];            /**< Peripheral identification register 0..Peripheral identification register 7, array offset: 0xFD0, array step: 0x4 */
  __I  uint32 CID[SCB_CID_COUNT];            /**< Component identification register 0..Component identification register 3, array offset: 0xFF0, array step: 0x4 */
...
#define SCB_ACTLR_ACTLR(x)                   (((uint32)(((uint32)(x))<<SCB_ACTLR_ACTLR_SHIFT))&SCB_ACTLR_ACTLR_MASK)
/* CPUID Bit Fields */
...
#define SCB_AIRCR_AIRCR(x)                   (((uint32)(((uint32)(x))<<SCB_AIRCR_AIRCR_SHIFT))&SCB_AIRCR_AIRCR_MASK)
/* SCR Bit Fields */
...
#define SCB_CCR_CCR(x)                       (((uint32)(((uint32)(x))<<SCB_CCR_CCR_SHIFT))&SCB_CCR_CCR_MASK)
/* SHPR1 Bit Fields */
#define SCB_SHPR1_SHPR1_MASK                 0xFFFFFFFFu
#define SCB_SHPR1_SHPR1_SHIFT                0u
#define SCB_SHPR1_SHPR1_WIDTH                32u
#define SCB_SHPR1_SHPR1(x)                   (((uint32)(((uint32)(x))<<SCB_SHPR1_SHPR1_SHIFT))&SCB_SHPR1_SHPR1_MASK)
/* SHPR2 Bit Fields */
#define SCB_SHPR2_SHPR2_MASK                 0xFFFFFFFFu
#define SCB_SHPR2_SHPR2_SHIFT                0u
#define SCB_SHPR2_SHPR2_WIDTH                32u
#define SCB_SHPR2_SHPR2(x)                   (((uint32)(((uint32)(x))<<SCB_SHPR2_SHPR2_SHIFT))&SCB_SHPR2_SHPR2_MASK)
/* SHPR3 Bit Fields */
#define SCB_SHPR3_SHPR3_MASK                 0xFFFFFFFFu
#define SCB_SHPR3_SHPR3_SHIFT                0u
#define SCB_SHPR3_SHPR3_WIDTH                32u
#define SCB_SHPR3_SHPR3(x)                   (((uint32)(((uint32)(x))<<SCB_SHPR3_SHPR3_SHIFT))&SCB_SHPR3_SHPR3_MASK)
/* SHCSR Bit Fields */
...
#define SCB_CFSR_MMFSR_IACCVIOL(x)           (((uint32)(((uint32)(x))<<SCB_CFSR_MMFSR_IACCVIOL_SHIFT))&SCB_CFSR_MMFSR_IACCVIOL_MASK)
#define SCB_CFSR_MMFSR_DACCVIOL_MASK         0x2u
#define SCB_CFSR_MMFSR_DACCVIOL_SHIFT        1u
#define SCB_CFSR_MMFSR_DACCVIOL_WIDTH        1u
#define SCB_CFSR_MMFSR_DACCVIOL(x)           (((uint32)(((uint32)(x))<<SCB_CFSR_MMFSR_DACCVIOL_SHIFT))&SCB_CFSR_MMFSR_DACCVIOL_MASK)
...
#define SCB_CFSR_MMFSR_MUNSTKERR(x)          (((uint32)(((uint32)(x))<<SCB_CFSR_MMFSR_MUNSTKERR_SHIFT))&SCB_CFSR_MMFSR_MUNSTKERR_MASK)
#define SCB_CFSR_MMFSR_MSTKERR_MASK          0x10u
#define SCB_CFSR_MMFSR_MSTKERR_SHIFT         4u
#define SCB_CFSR_MMFSR_MSTKERR_WIDTH         1u
#define SCB_CFSR_MMFSR_MSTKERR(x)            (((uint32)(((uint32)(x))<<SCB_CFSR_MMFSR_MSTKERR_SHIFT))&SCB_CFSR_MMFSR_MSTKERR_MASK)
#define SCB_CFSR_MMFSR_MLSPERR_MASK          0x20u
#define SCB_CFSR_MMFSR_MLSPERR_SHIFT         5u
#define SCB_CFSR_MMFSR_MLSPERR_WIDTH         1u
#define SCB_CFSR_MMFSR_MLSPERR(x)            (((uint32)(((uint32)(x))<<SCB_CFSR_MMFSR_MLSPERR_SHIFT))&SCB_CFSR_MMFSR_MLSPERR_MASK)
...
#define SCB_CFSR_MMFSR_MMARVALID(x)          (((uint32)(((uint32)(x))<<SCB_CFSR_MMFSR_MMARVALID_SHIFT))&SCB_CFSR_MMFSR_MMARVALID_MASK)
#define SCB_CFSR_BFSR_IBUSERR_MASK           0x100u
#define SCB_CFSR_BFSR_IBUSERR_SHIFT          8u
#define SCB_CFSR_BFSR_IBUSERR_WIDTH          1u
#define SCB_CFSR_BFSR_IBUSERR(x)             (((uint32)(((uint32)(x))<<SCB_CFSR_BFSR_IBUSERR_SHIFT))&SCB_CFSR_BFSR_IBUSERR_MASK)
#define SCB_CFSR_BFSR_PRECISERR_MASK         0x200u
#define SCB_CFSR_BFSR_PRECISERR_SHIFT        9u
#define SCB_CFSR_BFSR_PRECISERR_WIDTH        1u
#define SCB_CFSR_BFSR_PRECISERR(x)           (((uint32)(((uint32)(x))<<SCB_CFSR_BFSR_PRECISERR_SHIFT))&SCB_CFSR_BFSR_PRECISERR_MASK)
...
#define SCB_CFSR_BFSR_IMPRECISERR(x)         (((uint32)(((uint32)(x))<<SCB_CFSR_BFSR_IMPRECISERR_SHIFT))&SCB_CFSR_BFSR_IMPRECISERR_MASK)
#define SCB_CFSR_BFSR_UNSTKERR_MASK          0x800u
#define SCB_CFSR_BFSR_UNSTKERR_SHIFT         11u
#define SCB_CFSR_BFSR_UNSTKERR_WIDTH         1u
#define SCB_CFSR_BFSR_UNSTKERR(x)            (((uint32)(((uint32)(x))<<SCB_CFSR_BFSR_UNSTKERR_SHIFT))&SCB_CFSR_BFSR_UNSTKERR_MASK)
#define SCB_CFSR_BFSR_STKERR_MASK            0x1000u
#define SCB_CFSR_BFSR_STKERR_SHIFT           12u
#define SCB_CFSR_BFSR_STKERR_WIDTH           1u
#define SCB_CFSR_BFSR_STKERR(x)              (((uint32)(((uint32)(x))<<SCB_CFSR_BFSR_STKERR_SHIFT))&SCB_CFSR_BFSR_STKERR_MASK)
#define SCB_CFSR_BFSR_LSPERR_MASK            0x2000u
#define SCB_CFSR_BFSR_LSPERR_SHIFT           13u
#define SCB_CFSR_BFSR_LSPERR_WIDTH           1u
#define SCB_CFSR_BFSR_LSPERR(x)              (((uint32)(((uint32)(x))<<SCB_CFSR_BFSR_LSPERR_SHIFT))&SCB_CFSR_BFSR_LSPERR_MASK)
...
#define SCB_CFSR_BFSR_BFARVALID(x)           (((uint32)(((uint32)(x))<<SCB_CFSR_BFSR_BFARVALID_SHIFT))&SCB_CFSR_BFSR_BFARVALID_MASK)
...
#define SCB_CFSR_UFSR_UNDEFINSTR(x)          (((uint32)(((uint32)(x))<<SCB_CFSR_UFSR_UNDEFINSTR_SHIFT))&SCB_CFSR_UFSR_UNDEFINSTR_MASK)
#define SCB_CFSR_UFSR_INVSTATE_MASK          0x20000u
#define SCB_CFSR_UFSR_INVSTATE_SHIFT         17u
#define SCB_CFSR_UFSR_INVSTATE_WIDTH         1u
#define SCB_CFSR_UFSR_INVSTATE(x)            (((uint32)(((uint32)(x))<<SCB_CFSR_UFSR_INVSTATE_SHIFT))&SCB_CFSR_UFSR_INVSTATE_MASK)
#define SCB_CFSR_UFSR_INVPC_MASK             0x40000u
#define SCB_CFSR_UFSR_INVPC_SHIFT            18u
#define SCB_CFSR_UFSR_INVPC_WIDTH            1u
#define SCB_CFSR_UFSR_INVPC(x)               (((uint32)(((uint32)(x))<<SCB_CFSR_UFSR_INVPC_SHIFT))&SCB_CFSR_UFSR_INVPC_MASK)
#define SCB_CFSR_UFSR_NOCP_MASK              0x80000u
#define SCB_CFSR_UFSR_NOCP_SHIFT             19u
#define SCB_CFSR_UFSR_NOCP_WIDTH             1u
#define SCB_CFSR_UFSR_NOCP(x)                (((uint32)(((uint32)(x))<<SCB_CFSR_UFSR_NOCP_SHIFT))&SCB_CFSR_UFSR_NOCP_MASK)
...
#define SCB_CFSR_UFSR_UNALIGNED(x)           (((uint32)(((uint32)(x))<<SCB_CFSR_UFSR_UNALIGNED_SHIFT))&SCB_CFSR_UFSR_UNALIGNED_MASK)
