...
#define SPI_CR1_CPHA(x)                 (((uint16)(((uint16)(x))<<SPI_CR1_CPHA_SHIFT))&SPI_CR1_CPHA_MASK)

/* SPI CR1 - Clock polarity */
#define SPI_CR1_CPOL_MASK               0x2u
#define SPI_CR1_CPOL_SHIFT              1u
#define SPI_CR1_CPOL_WIDTH              1u
#define SPI_CR1_CPOL(x)                 (((uint16)(((uint16)(x))<<SPI_CR1_CPOL_SHIFT))&SPI_CR1_CPOL_MASK)
...
#define SPI_CR1_CRCNEXT(x)              (((uint16)(((uint16)(x))<<SPI_CR1_CRCNEXT_SHIFT))&SPI_CR1_CRCNEXT_MASK)
...
#define SPI_CR1_CRCEN(x)                (((uint16)(((uint16)(x))<<SPI_CR1_CRCEN_SHIFT))&SPI_CR1_CRCEN_MASK)
...
#define SPI_CR1_BIDIOE(x)               (((uint16)(((uint16)(x))<<SPI_CR1_BIDIOE_SHIFT))&SPI_CR1_BIDIOE_MASK)
...
#define SPI_CR1_BIDIMODE(x)             (((uint16)(((uint16)(x))<<SPI_CR1_BIDIMODE_SHIFT))&SPI_CR1_BIDIMODE_MASK)
...
#define SPI_CR2_RXDMAEN(x)              (((uint16)(((uint16)(x))<<SPI_CR2_RXDMAEN_SHIFT))&SPI_CR2_RXDMAEN_MASK)
...
#define SPI_CR2_RXNEIE(x)               (((uint16)(((uint16)(x))<<SPI_CR2_RXNEIE_SHIFT))&SPI_CR2_RXNEIE_MASK)
...
#define SPI_CR2_TXEIE(x)                (((uint16)(((uint16)(x))<<SPI_CR2_TXEIE_SHIFT))&SPI_CR2_TXEIE_MASK)
...
#define SPI_DR_DR(x)                    (((uint16)(((uint16)(x))<<SPI_CR2_RXNE_SHIFT))&SPI_CR2_RXNE_MASK)


/* Mask for all Error Flags */
#define SPI_SR_REG_FLAGS_MASK           0x1F8u
