...
#define DMA_CR_EN(x)						(((uint32_t)(((uint32_t)(x))<<DMA_CR_EN_SHIFT))&DMA_CR_EN_MASK)
...
#define DMA_CR_TCIE(x)						(((uint32_t)(((uint32_t)(x))<<DMA_CR_TCIE_SHIFT))&DMA_CR_TCIE_MASK)
...
#define DMA_CR_CT(x)						(((uint32_t)(((uint32_t)(x))<<DMA_CR_CT_SHIFT))&DMA_CR_CT_MASK)
...
#define DMA_CR_PBURST(x)					(((uint32_t)(((uint32_t)(x))<<DMA_CR_PBURST_SHIFT))&DMA_CR_PBURST_MASK)
...
#define DMA_CR_MBURST(x)					(((uint32_t)(((uint32_t)(x))<<DMA_CR_MBURST_SHIFT))&DMA_CR_MBURST_MASK)

/* Bit 25-27 - Channel selection */
#define DMA_CR_CHSEL_MASK					0xE000000u
#define DMA_CR_CHSEL_SHIFT					25u
#define DMA_CR_CHSEL_WIDTH					3u
#define DMA_CR_CHSEL(x)						(((uint32_t)(((uint32_t)(x))<<DMA_CR_CHSEL_SHIFT))&DMA_CR_CHSEL_MASK)
...
#define DMA_NDTR_NDT(x)						(((uint32_t)(((uint32_t)(x))<<DMA_NDTR_NDT_SHIFT))&DMA_NDTR_NDT_MASK)
...
#define DMA_PAR_PAR(x)						(((uint32_t)(((uint32_t)(x))<<DMA_PAR_PAR_SHIFT))&DMA_PAR_PAR_MASK)
...
#define DMA_M0AR_M0A(x)						(((uint32_t)(((uint32_t)(x))<<DMA_M0AR_M0A_SHIFT))&DMA_M0AR_M0A_MASK)
...
#define DMA_M1AR_M1A(x)						(((uint32_t)(((uint32_t)(x))<<DMA_M1AR_M1A_SHIFT))&DMA_M1AR_M1A_MASK)
...
#define DMA_LISR_FEIF_SHIFT(x)				(((uint32_t)x<<3)-(((uint32_t)x%2)>>1))
#define DMA_LISR_FEIF_WIDTH					1u
#define DMA_LISR_FEIF_MASK(x)				((uint32_t)1u<<(((uint32_t)x<<3)-(((uint32_t)x%2)>>1)))

/* Bit 23, 17, 7, 1 - Reserved */

/* Bit 24, 18, 8, 2 - Stream x direct mode error interrupt flag (x=3..0) */
#define DMA_LISR_DMEIF_SHIFT(x)				((((uint32_t)x<<3)-(((uint32_t)x%2)>>1))+2u)
#define DMA_LISR_DMEIF_WIDTH				1u
#define DMA_LISR_DMEIF_MASK(x)				((uint32_t)1u<<((((uint32_t)x<<3)-(((uint32_t)x%2)>>1)))+2u)

/* Bit 25, 19, 9, 3 - Stream x transfer error interrupt flag (x=3..0) */
#define DMA_LISR_TEIF_SHIFT(x)				((((uint32_t)x<<3)-(((uint32_t)x%2)>>1))+3u)
#define DMA_LISR_TEIF_WIDTH					1u
#define DMA_LISR_TEIF_MASK(x)				((uint32_t)1u<<((((uint32_t)x<<3)-(((uint32_t)x%2)>>1)))+3u)

/* Bit 26, 20, 10, 4 - Stream x half transfer interrupt flag (x=3..0) */
#define DMA_LISR_HTIF_SHIFT(x)				((((uint32_t)x<<3)-(((uint32_t)x%2)>>1))+4u)
#define DMA_LISR_HTIF_WIDTH					1u
#define DMA_LISR_HTIF_MASK(x)				((uint32_t)1u<<((((uint32_t)x<<3)-(((uint32_t)x%2)>>1)))+4u)

/* Bit 27, 21, 11, 5 - Stream x transfer complete interrupt flag (x = 3..0) */
#define DMA_LISR_TCIF_SHIFT(x)				((((uint32_t)x<<3)-(((uint32_t)x%2)>>1))+5u)
#define DMA_LISR_TCIF_WIDTH					1u
#define DMA_LISR_TCIF_MASK(x)				((uint32_t)1u<<((((uint32_t)x<<3)-(((uint32_t)x%2)>>1)))+5u)
